...
const config = {
  ...
  tagline: '编辑器信息适配到 Synthesizer V Studio 1.4.1，声库信息更新到星尘 Infinity，更新于 2021 / 12 / 16',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `磷元素P & 不羁阁 - Synthesizer V Studio Docs 更新于 2021 / 12 / 13 适配到 Synthesizer V Studio 1.4.1`,
      },
      prism: {
